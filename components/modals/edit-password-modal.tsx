...
export default function EditPasswordModal({ onClose, onSave, passwordData, folders, theme, onOpenHelp }: { onClose: () => void, onSave: (data: any) => void, passwordData: any, folders: any[], theme: string, onOpenHelp?: (id?: string) => void }) {
      ...
      <div className="bg-[#1e1e1e] text-white border border-blue-500/30 rounded-2xl shadow-2xl w-full max-w-md my-8 overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center p-6 border-b border-white/10 sticky top-0 bg-[#1e1e1e] z-10 backdrop-blur-md">
          <div className="flex items-center gap-3">
            <h2 className="text-xl font-bold text-blue-400">Edit Records</h2>
            <button 
                type="button"
                onClick={() => {
