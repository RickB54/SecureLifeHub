...
exports.noEquipmentExercises = exports.cardioExercises = exports.weightExercises = exports.slideboardExercises = exports.parseCSVData = exports.exercisesToCSV = exports.saveSavedWorkoutTemplates = exports.getSavedWorkoutTemplates = exports.saveWorkouts = exports.getWorkouts = exports.saveExercises = exports.getExercises = exports.generateId = void 0;
...
var getExercises = function () {
    try {
        var defaultExercises = __spreadArray(__spreadArray(__spreadArray(__spreadArray([], exports.slideboardExercises, true), exports.cardioExercises, true), exports.weightExercises, true), exports.noEquipmentExercises, true);
        var stored = localStorage.getItem('exercises');
        if (!stored) {
            return defaultExercises;
        }
        var parsedExercises = JSON.parse(stored);
        // Remove exact duplicates from localStorage to fix the 1000+ bug
        var seenNames = new Set();
        var deduplicated = [];
        for (var _i = 0, parsedExercises_1 = parsedExercises; _i < parsedExercises_1.length; _i++) {
            var ex = parsedExercises_1[_i];
        ...
        var defaultMap_1 = new Map(defaultExercises.map(function (e) { return [e.name, e]; }));
        // Remove duplicates that we permanently deleted from data.ts (like "Leg Press Machine")
        parsedExercises = parsedExercises.filter(function (ex) {
            if (ex.category === "Custom" || (ex.name && ex.name.startsWith("CF#")))
                return true;
            return defaultMap_1.has(ex.name);
        });
        parsedExercises = parsedExercises.map(function (ex) {
            var def = defaultMap_1.get(ex.name);
            if (def) {
                ...
                if (def.startPositionUrl && def.startPositionUrl !== ex.startPositionUrl) {
                    return __assign(__assign({}, ex), { startPositionUrl: def.startPositionUrl, endPositionUrl: def.endPositionUrl });
                }
            }
            return ex;
        });
        // FORCE SYNC: Add any entirely new exercises (like Cybex) that aren't in localStorage yet
        var existingNames = new Set(parsedExercises.map(function (e) { return e.name; }));
        for (var _a = 0, defaultExercises_1 = defaultExercises; _a < defaultExercises_1.length; _a++) {
            var def = defaultExercises_1[_a];
...
var saveExercises = function (exercises) {
    try {
...
var getWorkouts = function () {
    try {
        var stored = localStorage.getItem('workouts');
...
var saveWorkouts = function (workouts) {
...
exports.saveWorkouts = saveWorkouts;
var getSavedWorkoutTemplates = function () {
...
exports.getSavedWorkoutTemplates = getSavedWorkoutTemplates;
var saveSavedWorkoutTemplates = function (templates) {
    // localStorage disabled as per user request: "always go to Supabase"
    console.log("Supabase-only mode: saveTemplates to localStorage skipped");
};
exports.saveSavedWorkoutTemplates = saveSavedWorkoutTemplates;
var exercisesToCSV = function (exercises) {
    var headers = [
        'Name',
        'Category',
        'Muscle Groups',
    ...
    var rows = exercises.map(function (ex) {
        var _a, _b, _c, _d, _e;
        return [
            "\"".concat(((_a = ex.name) === null || _a === void 0 ? void 0 : _a.replace(/"/g, '""')) || '', "\""),
            "\"".concat(ex.category || '', "\""),
            "\"".concat(Array.isArray(ex.muscleGroups) ? ex.muscleGroups.join(', ') : '', "\""),
            "\"".concat(ex.equipment || '', "\""),
            "\"".concat(((_b = ex.notes) === null || _b === void 0 ? void 0 : _b.replace(/"/g, '""')) || '', "\""),
            "\"".concat(((_c = ex.description) === null || _c === void 0 ? void 0 : _c.replace(/"/g, '""')) || '', "\""),
            "\"".concat(((_d = ex.pictureUrl) === null || _d === void 0 ? void 0 : _d.replace(/"/g, '""')) || ((_e = ex.thumbnailUrl) === null || _e === void 0 ? void 0 : _e.replace(/"/g, '""')) || '', "\"")
        ].join(',');
    });
    return __spreadArray([headers], rows, true).join('\n');
};
exports.exercisesToCSV = exercisesToCSV;
var parseCSVData = function (csvText) {
    try {
        ...
        return lines.slice(1).map(function (line) {
            ...
            // Strip quotes
            var cleanValues = values.map(function (val) {
            ...
            var name = cleanValues[0], category = cleanValues[1], muscleGroupsStr = cleanValues[2], equipment = cleanValues[3], notes = cleanValues[4], description = cleanValues[5], pictureUrl = cleanValues[6];
            var muscleGroups = muscleGroupsStr ? muscleGroupsStr.split(',').map(function (g) { return g.trim(); }) : []; // Changed to RelaxedMuscleGroup
            // Create default settings based on category
            var settings;
            switch (category) { // Changed to RelaxedExerciseCategory
                case 'Weights':
            ...
            return {
                ...
                name: name,
                category: category, // Changed to RelaxedExerciseCategory
                muscleGroups: muscleGroups,
                equipment: equipment, // Changed to RelaxedEquipment
                settings: settings,
                notes: notes,
...
exports.slideboardExercises = [
    ...
    },
    {
        ...
        settings: { incline: 0, sets: 3, reps: 10 },
    },
    {
        id: (0, exports.generateId)(),
        name: "#26 Toe Raises",
...
exports.weightExercises = [
    {
        ...
        settings: { sets: 3, reps: 10, weight: 90 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        settings: { sets: 3, reps: 12, weight: 45 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        settings: { sets: 3, reps: 10, weight: 45 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        settings: { sets: 3, reps: 12, weight: 20 },
    },
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        settings: { sets: 3, reps: 10, weight: 80 },
    },
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 10, weight: 30 },
    },
    {
        id: (0, exports.generateId)(),
        name: "Deadlifts",
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 10, weight: 15 },
    },
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 10, weight: 60 },
    },
    {
        id: (0, exports.generateId)(),
        name: "Pull-Ups",
    ...
    // ─── Dumbbell Triceps ───────────────────────────────────────────────────────
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 12, weight: 25 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 10, weight: 25 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 10, weight: 35 },
    },
    // ─── Cable Triceps ──────────────────────────────────────────────────────────
    {
        id: (0, exports.generateId)(),
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 12, weight: 40 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 12, weight: 30 },
    },
    // ─── Dumbbell Biceps ────────────────────────────────────────────────────────
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 12, weight: 35 },
    },
    // ─── Chest Variations ───────────────────────────────────────────────────────
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 12, weight: 50 },
    },
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 10, weight: 65 },
    },
    // ─── Back Variations ────────────────────────────────────────────────────────
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 15, weight: 25 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 15, weight: 15 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 10, weight: 50 },
    },
    // ─── Legs ───────────────────────────────────────────────────────────────────
    {
        id: (0, exports.generateId)(),
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 12, weight: 150 },
    },
    {
        id: (0, exports.generateId)(),
        name: "Leg Extensions",
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 15, weight: 60 },
    },
    {
        id: (0, exports.generateId)(),
        name: "Leg Curls",
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 4, reps: 15, weight: 80 },
    },
    {
        id: (0, exports.generateId)(),
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 15, weight: 50 },
    },
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/7Hptjkc.png",
        settings: { sets: 3, reps: 5, weight: 100 },
    },
    // ─── Core ───────────────────────────────────────────────────────────────────
    {
        id: (0, exports.generateId)(),
...
exports.noEquipmentExercises = [
    ...
    },
    {
        ...
        settings: { time: 60, sets: 3, reps: 1 },
    },
    {
        id: (0, exports.generateId)(),
        name: "Pushups",
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/DjHjCRE.png",
        settings: { time: 60, sets: 3, reps: 0 },
    },
    {
        id: (0, exports.generateId)(),
    ...
    },
    {
        ...
        pictureUrl: "https://i.imgur.com/DjHjCRE.png",
        settings: { time: 60, sets: 3, reps: 20 },
    },
    {
        id: (0, exports.generateId)(),
        name: "Inchworms",
