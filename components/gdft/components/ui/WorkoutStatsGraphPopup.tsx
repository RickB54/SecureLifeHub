...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from '@/components/gdft/components/ui/dialog';
import { ChartContainer, ChartTooltip, ChartTooltipContent } from "@/components/gdft/components/ui/chart"
import { BarChart, Bar, Rectangle, XAxis, YAxis, CartesianGrid, Tooltip, Legend } from "recharts"
import { format } from 'date-fns';
import type { Workout } from '@/components/gdft/lib/data';
// The Exercise type is not exported from the context, so we use `any` here as a workaround to fix the build error.
// import type { Exercise } from '@/components/gdft/contexts/ExerciseContext';
